...
/**
 * This is the star tutorial.  It teaches the user about the star tile.
 * 
 * @author cdmckay
 */
public class StarTutorial extends AbstractTutorial
{          
    
    /**
     * The constructor.
     */
    public StarTutorial(Refactorer refactorer)
    {
        // Set the name.
    ...
    public void initialize(final Game game, final ManagerHub hub)
    {
        ...
        //game.levelMan.addItem(new Item.Builder(TileType.STAR)
    ...
    protected void createBoard(final Game game, ManagerHub hub)
    {
        ...
        boardMan.createTile(7, boardMan.getRows() - 1, 
    ...
    public void finish(Game game, ManagerHub hub)
    {
        ...
        // Add this item to the world manager.
        //game.levelMan.removeItem(TileType.STAR);
    }
