...
class HelpGroupLineLesson
{
    ...
    public HelpGroupLineLesson(ManagerHub hub, List<IEntity> parentEntities,
    ...
    private void createEntities(List<IEntity> entities)
    {
        ...
        for (int i = 0; i < Rows; i++)
        {
            ...
            {
                entities.add( this.tileGrid[j][i] );
