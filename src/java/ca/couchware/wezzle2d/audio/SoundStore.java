...
public class SoundStore
{
    ...
    private FloatBuffer sourceVel = BufferUtils.createFloatBuffer(3).put(new float[]
            {
                0.0f, 0.0f, 0.0f
            });
    ...
    public void init()
    {
        ...
        CouchLogger.get().recordMessage(this.getClass(), "Initialising sounds..");
        inited = true;
        ...
        AccessController.doPrivileged(new PrivilegedAction<Object>()
        {
            ...
            public Object run()
            {
                try
                {
                    ...
                    sounds = true;
                    music = true;
                    CouchLogger.get().recordMessage(this.getClass(), "- Sound works");
                }
                catch (Exception e)
                {
                    CouchLogger.get().recordException(this.getClass(), new Exception("Sound initialisation failure."));
        ...
        if (soundWorks)
        {
            ...
            CouchLogger.get().recordMessage(this.getClass(), "- " + sourceCount + " OpenAL source available");
            ...
            if (AL10.alGetError() != AL10.AL_NO_ERROR)
            {
                ...
                music = false;
                soundWorks = false;
                CouchLogger.get().recordException(this.getClass(), new Exception("- AL init failed"));
            }
            else
            {
                ...
                CouchLogger.get().recordMessage(this.getClass(), "- Sounds source generated");
            }
        }
    }
    ...
    public void poll(int delta)
    {
        ...
        if (music)
        {
            if (mod != null)
            {
                ...
                {
                    CouchLogger.get().recordException(this.getClass(), new Exception("Error with OpenGL MOD Player on this this platform"));
                    CouchLogger.get().recordException(this.getClass(), e);
                    mod = null;
                }
            }
            if (stream != null)
            {
                ...
                {
                    CouchLogger.get().recordException(this.getClass(), new Exception("Error with OpenGL Streaming Player on this this platform"));
                    CouchLogger.get().recordException(this.getClass(), e);
                    mod = null;
                }
            }
