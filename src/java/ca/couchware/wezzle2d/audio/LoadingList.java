...
public class LoadingList
{
    ...
    private List<DeferredResource> deferred = new ArrayList<DeferredResource>();
    ...
    public void remove(DeferredResource resource)
    {
        CouchLogger.get().recordException(this.getClass(),
                new Exception("Early loading of deferred resource due to req: " + resource.getDescription()));
        total--;
